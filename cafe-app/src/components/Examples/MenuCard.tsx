...
const MenuCard = (props: Props) => {
    ...
    return (
        <div className="bg-gray-400 shadow-sm rounded-md w-96 h-64">
            <div>
                <p className="text-gray-700 text-lg text-center font-bold">{menus.name}</p>
                </div>
                <div className="flex justify-between p-2">
                    ...
                    <div className="">
                        <PFCRadarChart 
                            data={{P: menus.nutrition.P, F: menus.nutrition.F,
                            C: menus.nutrition.C}}/>
                                ...
                                <thead className="border-b bg-neutral-200 font-medium">
                                    <tr >
                                        {['kcal', 'P', 'F', 'C'].map((inp: any) => (
                                            <th scope='col' className="w-6 px-2 py-1 text-center">{inp}</th>
                                        ))}
                                    </tr>
                                </thead>
                                <tbody>
