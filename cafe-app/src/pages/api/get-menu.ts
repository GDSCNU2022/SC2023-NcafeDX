...
export const categories = [
  { nameid: "teishoku", href: "/teishoku", name: "Lunch Set" },
  { nameid: "don", href: "/don", name: "Bowl" },
  { nameid: "noodle", href: "/noodle", name: "Noodle" },
  { nameid: "curry", href: "/curry", name: "Curry" },
];
...
export const getAllMenus: any = async (
  db: any,
  setFunc: Function,
...
export const getMenusInCategory: any = async (
  db: any,
  setFunc: Function,
  targetPath: string
) => {
...
export const deleteMenuWithName = async (
  db: any,
  targetRestaurant: string,
  menuName: string
) => {
